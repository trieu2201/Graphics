...
def main():
    ...
    model_gouraud = Elipsoid("./gouraud.vert", "./gouraud.frag").setup()
    gouraudPos = glm.translate(glm.mat4(1.0), glm.vec3(0.0, 0.0, 0.0))
    gouraudPos = glm.scale(gouraudPos, glm.vec3(1.0, 1.5, 1.0))

    model_phong = Elipsoid("./phong.vert", "./phong.frag").setup()
    phongPos = glm.translate(glm.mat4(1.0), glm.vec3(-4.0, 0.0, 0.0))
    phongPos = glm.scale(phongPos, glm.vec3(1.0, 1.5, 2.0))

    model_textured = Elipsoid("./phong.vert", "./phong.frag").setup(1)
    texturedPos = glm.translate(glm.mat4(1.0), glm.vec3(4.0, 0.0, 0.0))
    texturedPos = glm.scale(texturedPos, glm.vec3(1.0, 1.5, 3.0))
