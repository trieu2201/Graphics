...
def main():
    ...
    model_gouraud = Frustum("./gouraud.vert", "./gouraud.frag").setup()
    gouraudPos = glm.translate(glm.mat4(1.0), glm.vec3(0.0, 0.0, 0.0))

    model_phong = Frustum("./phong.vert", "./phong.frag").setup()
    phongPos = glm.translate(glm.mat4(1.0), glm.vec3(-4.0, 0.0, 0.0))

    model_textured = Frustum("./phong.vert", "./phong.frag").setup(1)
